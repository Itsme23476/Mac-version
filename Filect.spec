...
app = BUNDLE(
    ...
    info_plist={
        ...
        'CFBundleVersion': '14.1.15',
        'CFBundleShortVersionString': '14.1.15',
        ...
        'NSHumanReadableCopyright': 'Copyright © 2024-2026 Filect. All rights reserved.',
        'NSAppleEventsUsageDescription': 'Filect needs automation access to autofill file paths in other applications.',
